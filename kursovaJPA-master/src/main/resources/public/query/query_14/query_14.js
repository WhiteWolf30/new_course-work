var app = angular.module("query_14", []);
...
app.controller("AppCtrl", function ($scope, $http) {
    ...
    this.getStudentsWhoGetMoreThanOneEByGroup = function () {
        ...
        $http.get('/api/student/get who get more than one E by group?group_id=' + groupId).then(function (response) {
